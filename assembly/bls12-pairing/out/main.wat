(module
 ...
 (func $~lib/rt/stub/__realloc (; 23 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  i32.const 15
 ...
 (func $~lib/array/ensureSize (; 24 ;) (type $FUNCSIG$vi) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  i32.const 0
 ...
 (func $~lib/array/Array.create<u8> (; 25 ;) (type $FUNCSIG$i) (result i32)
  (local $0 i32)
  i32.const 16
  i32.const 4
  call $~lib/rt/stub/__alloc
 ...
 (func $~lib/rt/__allocArray (; 26 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  i32.const 16
  i32.const 4
 ...
 (func $main/main (; 27 ;) (type $FUNCSIG$i) (result i32)
  ...
  call $~lib/arraybuffer/ArrayBuffer#constructor
  local.tee $0
  call $websnark_bls12/bls12_pairing
  local.get $0
