(module
 ...
 (import "watimports" "$f1m_add" (func $websnark_bls12/bls12_f1m_add (param i32 i32 i32)))
 ...
 (import "watimports" "$bls12_pairing" (func $websnark_bls12/bls12_pairing (param i32 i32 i32)))
 (import "env" "eth2_blockDataSize" (func $main/eth2_blockDataSize (result i32)))
 (import "env" "bignum_f1m_add" (func $main/bignum_f1m_add (param i32 i32 i32)))
 ...
 (export "bignum_f1m_add" (func $main/bignum_f1m_add))
 ...
 (start $start)
 (func $~lib/rt/stub/maybeGrowMemory (; 15 ;) (type $FUNCSIG$vi) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  memory.size
 ...
 (func $~lib/rt/stub/__alloc (; 16 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  local.get $0
 ...
 (func $main/main (; 19 ;) (type $FUNCSIG$i) (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
