(module
    ...
    (i32.store offset=43192
      ...
      (i32.or
        (i32.load offset=43192
          (local.get $l1))
        (local.get $l2))))
  (func $f66 (type $t2) (param $p0 i32) (result i32)
    (local $l1 i32) (local $l2 i32)
    (local.set $l1
      (i32.shl
        (i32.shr_u
  ...
  (func $f67 (type $t0) (param $p0 i32) (param $p1 i32)
    ...
    (i64.store
      (i32.const 43216)
      (i64.const 0)))
  (func $f68 (type $t2) (param $p0 i32) (result i32)
    ...
    (if $I0
      ...
      (then
        ...
        (call $f65
          (local.get $p0))))
    (local.get $l1))
  (func $f69 (type $t5) (param $p0 i32) (param $p1 i32) (param $p2 i32)
      ...
      (loop $L1
        ...
        (local.set $l3
          (i32.add
            ...
            (i32.const 1)))
        (br $L1))))
  (func $f70 (type $t8) (param $p0 i32) (param $p1 i32) (param $p2 i32) (param $p3 i32)
    (local $l4 i32)
    (call $f69
      (local.get $p0)
      (local.get $p2)
    ...
    (if $I2
      ...
      (then
        ...
        (call $g1m_add
          ...
          (local.get $p4)
          (local.get $p4)))))
  (func $f72 (type $t8) (param $p0 i32) (param $p1 i32) (param $p2 i32) (param $p3 i32)
    (local $l4 i32) (local $l5 i32)
    (call $f69
      (local.get $p0)
      (local.get $p2)
      ...
      (loop $L1
        ...
        (local.set $l4
          (i32.add
            ...
            (i32.const 1)))
        (br $L1))))
  (func $f73 (type $t0) (param $p0 i32) (param $p1 i32)
    (local $l2 i32)
    (local.set $l2
      (i32.const 0))
    (block $B0
      (loop $L1
        ...
        (local.set $l2
          (i32.add
            ...
            (i32.const 1)))
        (br $L1))))
  (func $f74 (type $t5) (param $p0 i32) (param $p1 i32) (param $p2 i32)
    (local $l3 i32) (local $l4 i32)
    (local.set $l4
      (local.get $p0))
    (call $g1m_copy
  ...
  (func $g1m_multiexp2 (type $t9) (param $p0 i32) (param $p1 i32) (param $p2 i32) (param $p3 i32) (param $p4 i32)
    ...
    (call $g1m_add
      ...
      (local.get $p4)
      (local.get $p4)))
  (func $f76 (type $t3) (param $p0 i32) (param $p1 i32) (result i32)
    (i32.rotl
      (i32.add
        (i32.add
          (i32.shl
        ...
        (i32.add
          ...
          (i32.load8_u offset=83512
            (i32.and
              ...
              (i32.const 255)))))
      (local.get $p1)))
  (func $f77 (type $t0) (param $p0 i32) (param $p1 i32)
      ...
      (loop $L1
        ...
        (local.set $l3
          (i32.add
            ...
            (i32.const 1)))
        (br $L1))))
  (func $f78 (type $t5) (param $p0 i32) (param $p1 i32) (param $p2 i32)
      ...
      (loop $L1
        ...
        (local.set $l4
          (i32.add
            ...
            (i32.const 32)))
        (br $L1))))
  (func $f82 (type $t0) (param $p0 i32) (param $p1 i32)
    ...
    (call $frm_mul
      ...
      (local.get $l4)
      (local.get $l8)))
  (func $f83 (type $t2) (param $p0 i32) (result i32)
    (local $l1 i32) (local $l2 i32)
    (local.set $l2
      (i32.shr_u
        (local.get $p0)
      ...
      (loop $L1
        ...
        (br_if $B0
          (i32.eqz
            (local.get $l4)))
        (br $L1))))
  (func $f118 (type $t1) (param $p0 i32)
    (local $l1 i32) (local $l2 i32)
    (local.set $l1
      (i32.shl
        (i32.shr_u
  ...
  (func $f119 (type $t2) (param $p0 i32) (result i32)
    ...
    (i32.and
      (i32.load offset=162392
        (local.get $l1))
      (local.get $l2)))
  (func $f120 (type $t0) (param $p0 i32) (param $p1 i32)
    (local $l2 i32) (local $l3 i32) (local $l4 i32) (local $l5 i32)
    (local.set $l2
      (local.get $p0))
    (call $g2m_zero
    ...
    (i64.store
      (i32.const 162416)
      (i64.const 0)))
  (func $f121 (type $t2) (param $p0 i32) (result i32)
    (local $l1 i32) (local $l2 i32) (local $l3 i32)
    (local.set $l1
      (i32.add
        (i32.const 88664)
    ...
    (if $I0
      ...
      (then
        ...
        (call $f118
          (local.get $p0))))
    (local.get $l1))
  (func $f122 (type $t5) (param $p0 i32) (param $p1 i32) (param $p2 i32)
    (local $l3 i32) (local $l4 i32) (local $l5 i64) (local $l6 i64)
    (local.set $l3
      (i32.const 0))
    (block $B0
      (loop $L1
        ...
        (local.set $l3
          (i32.add
            ...
            (i32.const 1)))
        (br $L1))))
  (func $f123 (type $t8) (param $p0 i32) (param $p1 i32) (param $p2 i32) (param $p3 i32)
    (local $l4 i32)
    (call $f122
      (local.get $p0)
      (local.get $p2)
    ...
    (if $I2
      ...
      (then
        ...
        (call $g2m_add
          ...
          (local.get $p4)
          (local.get $p4)))))
  (func $f125 (type $t8) (param $p0 i32) (param $p1 i32) (param $p2 i32) (param $p3 i32)
    (local $l4 i32) (local $l5 i32)
    (call $f122
      (local.get $p0)
      (local.get $p2)
      ...
      (loop $L1
        ...
        (local.set $l2
          (i32.add
            ...
            (i32.const 1)))
        (br $L1))))
  (func $f127 (type $t5) (param $p0 i32) (param $p1 i32) (param $p2 i32)
    (local $l3 i32) (local $l4 i32)
    (local.set $l4
      (local.get $p0))
    (call $g2m_copy
  ...
  (func $g2m_multiexp2 (type $t9) (param $p0 i32) (param $p1 i32) (param $p2 i32) (param $p3 i32) (param $p4 i32)
    ...
    (call $g2m_add
      ...
      (local.get $p4)
      (local.get $p4)))
  (func $f129 (type $t0) (param $p0 i32) (param $p1 i32)
    (call $int_copy
      (local.get $p0)
      (i32.const 239480))
    (call $f1m_sub
  ...
  (func $f6m_mul (type $t5) (param $p0 i32) (param $p1 i32) (param $p2 i32)
    (call $main/debug_print32 (i32.const 99))
    (call $f2m_mul
      (local.get $p0)
      (local.get $p1)
      (i32.const 239528))
      ...
      (loop $L1
        ...
        (br_if $B0
          (i32.eqz
            (local.get $l4)))
        (br $L1))))
  (func $f145 (type $t0) (param $p0 i32) (param $p1 i32)
    (call $f2m_copy
      (local.get $p0)
      (i32.const 242792))
    (call $f129
  ...
  (func $ftm_mul014 (type $t9) (param $p0 i32) (param $p1 i32) (param $p2 i32) (param $p3 i32) (param $p4 i32)
    ...
    (call $f6m_add
      ...
      (i32.const 247560)
      (local.get $p4)))
  (func $f166 (type $t5) (param $p0 i32) (param $p1 i32) (param $p2 i32)
    (call $f1m_mul
      (local.get $p1)
      (i32.add
        (local.get $p0)
  ...
  (func $bls12381__frobeniusMap9 (type $t0) (param $p0 i32) (param $p1 i32)
    ...
    (call $f2m_mul
      ...
      (i32.add
        (local.get $p1)
        (i32.const 480))))
  (func $f177 (type $t5) (param $p0 i32) (param $p1 i32) (param $p2 i32)
    (call $f2m_square
      (i32.add
        (local.get $p0)
        (i32.const 192))
    ...
    (call $f2m_add
      ...
      (i32.add
        (local.get $p2)
        (i32.const 96))))
  (func $f178 (type $t0) (param $p0 i32) (param $p1 i32)
    (call $f2m_square
      (local.get $p0)
      (local.get $p1))
    (call $f2m_square
